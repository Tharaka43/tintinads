...
const KPI_DATA: KPI[] = [
    ...
    { id: 3, title: 'Total Spent', value: 'Rs. 0', trend: 'Total amount spent', trendColor: 'text-blue-600', icon: 'fas fa-wallet', iconBg: 'bg-blue-100', iconColor: 'text-blue-600' },
    { id: 4, title: 'Total Views', value: '0', trend: 'Across all your ads', trendColor: 'text-green-600', icon: 'fas fa-eye', iconBg: 'bg-pink-100', iconColor: 'text-primary-pink' },
];
