                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
                        ...
                        <form onSubmit={handleCreateAgent} className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" required minLength={8} value={newAgent.password} onChange={e => setNewAgent({...newAgent, password: e.target.value})} className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-all" placeholder="Minimum 8 characters" />
                            </div>
                            <div className="pt-2">
                                <button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold py-3 rounded-xl shadow-md hover:shadow-lg disabled:opacity-70 transition-all">
